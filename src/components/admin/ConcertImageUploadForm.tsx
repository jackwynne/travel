...
interface ConcertImageUploadFormProps {
...
export function ConcertImageUploadForm({
	concertId,
	onSuccess,
	onCancel,
}: ConcertImageUploadFormProps) {
		...
		try {
			await updateImage({
				image: {
					...
					location: {
						imageType: "concert" as const,
						locationId: concertId,
					},
				},
			});
	...
	}, [uploadedImage, processedImage, updateImage, concertId, onSuccess]);
